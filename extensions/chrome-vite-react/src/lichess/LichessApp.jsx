          ...
          <div className="ca_section ca_opponent_info">
            <div className="ca_elo_range">
              <div className="ca_elo_range_lowest">
                <div
                  className={`ca_elo_range_lowest_value ca_placeholder ${
                    userAnalytics ? "" : "ca_placeholder_enabled"
                  }`}
                >
                  ????
                </div>
              ...
              <div className="ca_elo_range_current">
                <div
                  className={`ca_elo_range_current_value ca_placeholder ${
                    userAnalytics ? "" : "ca_placeholder_enabled"
                  }`}
                >
                  ????
              ...
              <div className="ca_elo_range_highest">
                <div
                  className={`ca_elo_range_highest_value ca_placeholder ${
                    userAnalytics ? "" : "ca_placeholder_enabled"
                  }`}
                >
                  ????
            ...
            >
              ...
              <div className="ca_opponent_info_section" title="Disconnects">
                ...
                <span className={`ca_disconnects ca_placeholder ${userAnalytics ? "" : "ca_placeholder_enabled"}`}>
                  {
                      userAnalytics ? `${((userAnalytics.performance.totalNumberOfDisconnects / userAnalytics.performance.totalNumberOfGames) * 100).toFixed(1)}%` : "????"}
                </span>
              </div>
              <div className="ca_opponent_info_section" title="Streak">
                <span data-icon=""></span>
                <span className={`${userAnalytics ? userAnalytics.performance.currentLosingStreak > 0 ? "ca_negative" : userAnalytics.performance.currentWinningStreak > 0 ? "ca_positive" : "" : ""} ca_win_streak_value ca_placeholder ${userAnalytics ? "" : "ca_placeholder_enabled"}`}>
                  {userAnalytics ? userAnalytics.performance.currentLosingStreak > 0 ? `-${userAnalytics.performance.currentLosingStreak}` :  userAnalytics.performance.currentWinningStreak > 0 ? `+${userAnalytics.performance.currentWinningStreak}` : "0"  : "???" }
                </span>
              </div>
            </div>
          </div>
