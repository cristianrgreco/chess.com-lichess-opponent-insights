      ...
      {accessToken ? (
        <div className="ca_container">
          <div className="ca_section ca_opponent_info">
            <div className="ca_elo_range">
              <div className="ca_elo_range_lowest">
                <div
                  className={`ca_elo_range_lowest_value ca_placeholder ${userAnalytics ? "" : "ca_placeholder_enabled"}`}
                >
                  ????
                </div>
              </div>
              <div className="ca_elo_range_current">
                <div
                  className={`ca_elo_range_current_value ca_placeholder ${userAnalytics ? "" : "ca_placeholder_enabled"}`}
                >
                  ????
                </div>
              </div>
              <div className="ca_elo_range_highest">
                <div
                  className={`ca_elo_range_highest_value ca_placeholder ${userAnalytics ? "" : "ca_placeholder_enabled"}`}
                >
                  ????
                </div>
              </div>
            ...
            <div style={{ display: "flex", alignItems: "center", fontSize: "12px" }}>
              ...
              <div className="ca_opponent_info_section" title="Streak">
                <span data-icon=""></span>
                <span className={`ca_win_streak_value ca_placeholder ${userAnalytics ? "" : "ca_placeholder_enabled"}`}>
                  ???
                </span>
              </div>
            </div>
          ...
          <div className="ca_section ca_tabs">
            ...
            <span
              className={`ca_tab ca_tab_icon ca_notes_tab_trigger ${currentTab === "NOTES" ? "ca_active" : ""} ${opponentNotes ? "ca_green_colour" : ""}`}
