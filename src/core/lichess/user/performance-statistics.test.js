...
describe("Lichess performance statistics", () => {
  it("should return a user's highest rating", async () => {
    const userPerformanceStatistics = await fetchLichessUserPerformanceStatistics("tmevans", "blitz");
  ...
  it("should return tilt mode true if loss greater gte 3", async () => {
    const userPerformanceStatistics = await fetchLichessUserPerformanceStatistics("iwishicouldcode", "blitz");
